...
public class QueueResponseServiceImp implements QueueResponseService {
    ...
    public List<Cities> getCity() {
        ...
        try {
            ...
            /*String response = "[{\"id\":1,\"name\":\"Leon\",\"tax\":10,\"seaport\":false,\"airport\":false},"+
                    "{\"id\":2,\"name\":\"Chihuahua\",\"tax\":10,\"seaport\":false,\"airport\":false},"+
                    "{\"id\":3,\"name\":\"Aguascalientes\",\"tax\":10,\"seaport\":false,\"airport\":false}]";
            */
