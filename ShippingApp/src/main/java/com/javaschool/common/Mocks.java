...
public class Mocks {
    ...
    public String messageResponse(QueueMessageRequest messageRequest) {
        String response = "";
        if ("packageSize".equals(messageRequest.getType())) {
        ...
        if ("packageType".equals(messageRequest.getType())) {
            response = "[{\"id\":2,\"description\":\"Box\",\"price\":10},{\"id\":3,\"description\":\"Envelope\",\"price\":5}]";
        }
        if ("transportVelocity".equals(messageRequest.getType())) {
        ...
        if ("transportType".equals(messageRequest.getType())) {
            response = "[{\"id\":2,\"description\":\"Land\",\"pricePerMile\":2},{\"id\":1,\"description\":\"Air\",\"pricePerMile\":5}]";
        }
        if ("city".equals(messageRequest.getType())) {
        ...
        if ("routesList".equals(messageRequest.getType())) {
            response = "[\n" +
                    "{\n" +
                    "\"from\": \"Ensenada\",\n" +
                    "\"to\": \"Cancun\",\n" +
